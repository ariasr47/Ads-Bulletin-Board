        ...
        >
            <Paper className={classes.drawerOverlay} elevation={4}>
                ...
                <div className={classes.drawerContainer}>
                    ...
                    <List>
                        <ListItem button>
                            <ListItemIcon> <Icon component={FaMicrochip} color={"disabled"}/> </ListItemIcon>
                            <ListItemText primary={"Electronics"}/>
                        </ListItem>
                        <ListItem button>
                            <ListItemIcon> <Icon component={FaCarSide} color={"disabled"}/> </ListItemIcon>
                            <ListItemText primary={"Vehicles"}/>
                        </ListItem>
                        <ListItem button>
                            <ListItemIcon> <Icon component={FaTshirt} color={"disabled"}/> </ListItemIcon>
                    ...
                    <List>
                        <ListItem button key={"Favorites"}>
                            <ListItemIcon><Icon component={FaHeart} color="disabled"/> </ListItemIcon>
